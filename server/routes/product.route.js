...
const { createProduct, getProducts, bookProduct, addToWishlist, showBookedProperties,showWishlist,cancelBooking,scheduleMeeting} = require("../controllers/product.controller");
