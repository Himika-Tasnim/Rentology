...
const createProduct = async (req, res) => {
  try {
    ...
    // Check if the uploaded image file exists and assign the filename
    ...
    const { availableDate, paymentType, email } = req.body;
    ...
    // Create a new product in the database with all required fields
...
const showBookedProperties = async (req, res) => {
  ...
  try {
      ...
      console.log(bookings); // Log the bookings
